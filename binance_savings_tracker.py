...
def parse_args():
    ...
    parser.add_argument("end_date", help="End Date of transactions." )
    ...
    return args.ticker, args.income_type, args.start_date, args.end_date, args.output_file, args.currencies


def process_request(ticker, income_type, start_date, end_date, output_file, currencies):
    """
